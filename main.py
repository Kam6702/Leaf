...
default_config = {
        "token": "ODczODI5NjM4NTYzMDQ1NDE3.YQ-HRA.GU9W84gZ7XV5KHENH8ZgzVNGn9Y",
        "developers": 637884461161381899,
        "replacements": {},
        "prefix": ".",
        "mod_role": 851655788623429642,
        "blacklist": [],
        "server": 851575406057357362,
        "mail_channel": 869896553173762048,
        "from_field": 1,
}
...
class ModmailBot(Cog):
    ...
    async def on_ready(self):
        ...
        await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.listening, name="your modmail"))
